...
<img style="max-width: 100%; height: 400px;" src="images/resources/avion.jpg" alt="">
...
<img src="images/resources/pacha.jpg" alt="">
...
<div class="post-bar">
    ...
    <div class="usy-name">
    <h3>John Doe</h3>
    <span><img src="images/clock.png" alt="">il y'a 3 min</span>
    </div>
    </div>
    <div class="ed-opts">
    <a href="#" title="" class="ed-opts-open"><i class="la la-ellipsis-v"></i></a>
    ...
    <div class="epi-sec">
    <ul class="descp">
    <li><img src="images/icon8.png" alt=""><span class="bid_now" style="color: white;">Devellopper</span></li>
    <li><img src="images/icon9.png" alt=""><span>Sera en vaccance au <p class="bid_now">Cameroun</p></span></li>
    </ul>
    <ul class="job-dt">
        <li><p>Du 06/06/2011</p></li>
        <li><p>Au: 08/06/2022 </p></li>
        <li><span>Au prix de $30 / hr</span></li>
    </ul>
    </div>
    <div class="job_descp">
    <h3> Le prix du tapiocat</h3>
    <!--IMage du post-->
    <img class="imgpos" src="images/forum.png">
    </div>
    
    <p class="debordement">Lorem ipsum dolor sit amet,consectetur adipiscing elit. Aliquam luctus hendrerit metus, ut ullamcorper quam finibus at. Etiam id magna sit amet</p>
    
    <div class="job-status-bar">
    <a href="#openModal" class="com"><i class="fas fa-comment-alt"></i> <button> Commentaire </button>
            ...
            <div class="modal_content">
                ...
                <div class="profile_user">
                    <img 
                                        ...
                                        "
                                        />
                    <h3 class="h">Velosso</h3>
                </div>
                <p class="p2">sfhdsuhfusfhsuidfhsdufhisdfhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhu</p>
                <div class="profile_user1">
                    <img 
                                        src="images/resources/bg-img1.png"
                                        alt="avatar"
                                        class="rounded-circle me-2"
                ...
                <p class="p23">sfhdsuhfusfhsuidfhsdufhisdfhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhh</p>
                ...
                <fom>
                    <img 
                                        ...
                                        />
                    <h3 class="h">Velosso</h3>
                    <input class="input1" type="text" placeholder="commenter">
          ...
          <form class="form" action="##" method="post" id="registrationForm">
              ...
              <div class="form-group">
                  ...
                  <div class="col-xs-6">
                      ...
                      <P>franklindjoumessi@gmail.com</P>
                  </div>
              </div>
              <div class="form-group">
